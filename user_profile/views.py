...
def edit_profile(request):
    ...
    return render(request, 'user_profile/edit_profile.html', {'form': form, 'show_navbar': True})
...
def register(request):
    ...
    return render(request, 'user_profile/register.html', {'form': form, 'show_navbar': True})
...
def login_view(request):
    if request.method == 'POST':
        ...
        form = LoginForm()
    return render(request, 'user_profile/login.html', {'form': form, 'show_navbar': True})
